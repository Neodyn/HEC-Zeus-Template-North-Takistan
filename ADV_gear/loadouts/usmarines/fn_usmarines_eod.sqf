...
_itemsPrimaryweapon = ["rhsusf_acc_ACOG_d"];
...
_itemsBackpack = ["MineDetector","DemoCharge_Remote_Mag","DemoCharge_Remote_Mag","DemoCharge_Remote_Mag","rhsusf_ANPVS_14","Toolkit"];
