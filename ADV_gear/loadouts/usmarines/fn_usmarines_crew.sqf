...
_primaryweaponAmmo = [7,"rhs_mag_30Rnd_556x45_Mk318_Stanag"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
