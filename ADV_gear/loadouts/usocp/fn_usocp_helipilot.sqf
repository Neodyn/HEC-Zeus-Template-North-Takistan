...
_primaryweapon = "rhsusf_weap_MP7A1_base_f";
...
_primaryweaponAmmo = [9,"rhsusf_mag_40Rnd_46x30_JHP"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
