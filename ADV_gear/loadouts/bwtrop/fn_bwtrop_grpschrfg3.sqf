...
_primaryweaponAmmo = [11,"BWA3_10Rnd_762x51_G28_AP"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
//_additionalAmmo = [1,"BWA3_10Rnd_762x51_G28_AP"]; //additional ammo classes up to 3: //_additionalAmmo2 ///_additionalAmmo3
