...
_itemsPrimaryweapon = ["BWA3_optic_24x72"];
_silencer = "";		//if silencer is added

//primary weapon ammo (if a primary weapon is given) and how many tracer mags - (integer)
_primaryweaponAmmo = [11,"BWA3_10Rnd_127x99_G82_AP_Tracer"];		//first number: Amount of magazines, second number: config index of magazine or classname of magazine type.
////_additionalAmmo = [1,"BWA3_10Rnd_127x99_G82_Raufoss_Tracer"]; //additional ammo classes up to 3: //_additionalAmmo2 ///_additionalAmmo3
